            ...
            body: ListView(
              ...
              children: [
                ...
                ListTile(
                  ...
                  subtitle: const Text('Invite your friends to use BizNearby'),
                  trailing: const Icon(Icons.chevron_right_rounded, color: Colors.grey),
                  onTap: () => _shareApp(
                    message: "Hey! Check out BizNearby - A global directory for local shops with real-time promos. Download it now to find local deals! https://play.google.com/store/apps/details?id=com.help.businessdiary",
                  ),
                ),
                ListTile(
                  ...
                  trailing: const Icon(Icons.chevron_right_rounded, color: Colors.grey),
                  onTap: () => _shareApp(
                    message: "BizNearby - The ultimate platform for local shop discovery and real-time promos. Get it here: https://play.google.com/store/apps/details?id=com.help.businessdiary",
                  ),
                ),
                const Padding(
                  padding: EdgeInsets.symmetric(vertical: 8.0, horizontal: 4.0),
